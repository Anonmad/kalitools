...
'
echo " " 
echo -e "$red                       ▶Coded by$grn KALI$red◀$rset"
echo -e "$red                      ⫸$ylo  Os Hackers$red ⫷$rset"
echo 
# Functions
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mKALI" | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mOs HACKERS" | pv -qL 10
